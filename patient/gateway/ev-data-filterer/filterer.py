...
def on_connect(client, userdata, flags, rc):
    ...
    if rc == 0:
        ...
        print("Subscribed to raw-data topic")
        sys.stdout.flush()
    else:
...
def on_message(client, userdata, msg):
    ...
    if data["type"] == "heart_rate":
        ...
        # Add the new heart rate value to the data accumulator
        heart_rate_data.append(data["value"])

        # If the data accumulator has more than 5 values, send average to "filtered-data" topic
